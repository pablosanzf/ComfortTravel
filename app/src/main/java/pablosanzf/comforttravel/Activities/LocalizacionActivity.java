...
public class LocalizacionActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtLocation = (TextView) findViewById(R.id.txtLocalizacion);
    ...
    private boolean connectToGooglePlayServices() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(LocalizacionActivity.this)
    ...
    private class RefreshLocation extends AsyncTask<String, Integer, String>{
        ...
        protected void onPostExecute(String result) {
            ...
            if(result != null){
                ...
                Toast.makeText(LocalizacionActivity.this, R.string.msg_error_server, Toast.LENGTH_SHORT).show();
            }
        }
